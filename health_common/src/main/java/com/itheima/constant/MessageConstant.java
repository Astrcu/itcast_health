...
public class MessageConstant {
    ...
    public static final String GET_MEMBER_TYPE_REPORT_BYAGE_SUCCESS = "根据年龄获取会员占比成功";
    public static final String GET_MEMBER_TYPE_REPORT_BYAGE_FAIL = "根据年龄获取会员占比失败";
    public static final String GET_MEMBER_TYPE_REPORT_BYSEX_SUCCESSS = "根据性别获取会员占比成功";
    public static final String GET_MEMBER_TYPE_REPORT_BYSEX_FAIL = "根据性别获取会员占比失败";
    ...
    public static final String QUERY_ROLE_SUCCESS = "查询所有用户成功";
    public static final String QUERY_ROLE_FAIL = "查询所有用户失败";
    public static final String EDIT_MENU_SUCCESS = "修改菜单成功";
    public static final String EDIT_MENU_FAIL = "修改菜单失败";
    public static final String QUERY_MENU_SUCCESS = "回显菜单成功";
    public static final String QUERY_MENU_FAIL = "回显菜单成功";
